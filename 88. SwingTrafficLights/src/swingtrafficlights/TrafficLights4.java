 ...
 */
public class TrafficLights4 extends javax.swing.JPanel {

    private TrafficLightModel model;
    public static Thread trafficLight4Thread;

    public TrafficLights4() {

        initComponents();

        model = new TrafficLightModel(true, false, false, true, false, false, true, false, false,true, false, false);

        TrafficLightRunner4 trafficLightRunner4 = new TrafficLightRunner4(model, this);
        (new Thread(trafficLightRunner4)).start();
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (model.isYellow4() && model.isRed4()) {
        ...
        } else if (model.isYellow4() && !model.isRed4()) {
