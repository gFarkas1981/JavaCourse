 ...
 */
public class TrafficLights3 extends javax.swing.JPanel {

    private TrafficLightModel model;
    public static Thread trafficLight3Thread;

    public TrafficLights3() {

        initComponents();

        model = new TrafficLightModel(true, false, false, true, false, false, true, false, false,true, false, false);

        TrafficLightRunner3 trafficLightRunner3 = new TrafficLightRunner3(model, this);
        (new Thread(trafficLightRunner3)).start();
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (model.isYellow3() && model.isRed3()) {
        ...
        } else if (model.isYellow3() && !model.isRed3()) {
