 ...
 */
public class TrafficLights2 extends javax.swing.JPanel {

    private TrafficLightModel model;
    public static Thread trafficLight2Thread;

    public TrafficLights2() {

        initComponents();

        model = new TrafficLightModel(true, false, false, true, false, false, true, false, false,true, false, false);

        TrafficLightRunner2 trafficLightRunner2 = new TrafficLightRunner2(model, this);
        (new Thread(trafficLightRunner2)).start();
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (model.isYellow2() && model.isRed2()) {
        ...
        } else if (model.isYellow2() && !model.isRed2()) {
